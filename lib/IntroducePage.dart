...
class IntroducePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = [
      {'title': 'สวัสดี', 'subtitle': 'ใช้ในการทักทายตอนพบกัน'},
      {'title': 'ฉันมาจาก...', 'subtitle': 'บอกว่ามาจากประเทศอะไร'},
      {'title': 'ฉัน / ผม?', 'subtitle': 'แนะนำตัวว่าชื่ออะไร'},
      {'title': 'ชื่อเล่น', 'subtitle': 'แนะนำชื่อเล่นของตนเอง'},
    ];
    return Scaffold(
      drawer: const Navbar(),
      body: Stack(

...
class EmotionPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = [
      {'title': 'ยินดีด้วย', 'subtitle': 'ใช้แสดงความยินดี'},
      {'title': 'เสียใจด้วย', 'subtitle': 'แสดงความเสียใจ'},
      {'title': 'ตกใจ', 'subtitle': 'แสดงความตกใจหรือประหลาดใจ'},
      {'title': 'ดีใจ / ขอบคุณ', 'subtitle': 'แสดงความขอบคุณหรือความยินดี'},
    ];
    return Scaffold(
      drawer: const Navbar(),
      body: Stack(

...
class TravelPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = [
      {'title': 'ไปที่ไหน?', 'subtitle': 'ใช้ถามทิศทางหรือจุดหมายปลายทาง'},
      {'title': 'รถเมล์ / รถแท็กซี่', 'subtitle': 'บอกวิธีการเดินทาง'},
      {'title': 'ไกล / ใกล้', 'subtitle': 'ถามระยะทาง'},
      {'title': 'แผนที่', 'subtitle': 'ขอแผนที่หรือทิศทาง'},
    ];
    return Scaffold(
      drawer: const Navbar(),
      body: Stack(
